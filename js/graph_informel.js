...
function init() {
  ...
  // 🧩 Les nœuds sont déplaçables par défaut (pas de .movable = false ici)
  ...
  // 🛠️ Initialiser les outils et charger les données
  setupButtons();
  setupColorPanel();
  loadData(); // le layout est figé juste après génération dans cette fonction
}
...
function loadData() {
  Promise.all([
    ...
    // Appliquer une seule fois le TreeLayout
